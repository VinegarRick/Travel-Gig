...
public class Hotel {	
	...
	@JoinTable(
		    name = "hotels_amenities",  // Name of the join table
		    joinColumns = @JoinColumn(name = "hotelId"),  // Column in the join table that links to Hotel
		    inverseJoinColumns = @JoinColumn(name = "a_id")  // Column in the join table that links to Amenities
	)
	...
	@JoinTable(
		    name = "hotels_hotel_rooms",  // Name of the join table
		    joinColumns = @JoinColumn(name = "hotelid"),  // Column in the join table that links to Hotel
		    inverseJoinColumns = @JoinColumn(name = "hotelroomid")  // Column in the join table that links to HotelRoom
	)
