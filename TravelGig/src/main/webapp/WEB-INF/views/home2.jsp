...
<div class="col-7 border rounded" style="margin-left:50px;">
	...
	<div id="listHotel">
		<table id="hotelTbl" border="1"><tr class="header"><th>Hotel Name</th><th>Hotel Price</th><th>Hotel Rating</th><th>Image</th></tr></table>
	</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
        <div class="col">
        	...
        	<input style="margin-top:25px" class="btn btn-addGuests form-control btn-primary" type="button" id="" value="ADD GUESTS"/>       	
        </div>
